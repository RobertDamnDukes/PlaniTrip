        ...
        <>
            <nav>
                ...
                <div className="links-container">
                    ...
                    <Link href="/">Logo</Link>
                    <Link href="/planning" className={pathname === "/planning" ? "active-link" : ""}>Planning</Link>
                    <Link href="/flights" className={pathname === "/flights" ? "active-link" : ""}>Flights</Link>
                    <Link href="/about" className={pathname === "/about" ? "active-link home-link" : "home-link"}>About</Link>
                    <Link href="/settings">
                        <svg className="settings-btn marginToRight" aria-label="Settings" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" fill="#e8eaed">
                    ...
                    <Link href="/login" className="sign-up-button">
                        Sign up
