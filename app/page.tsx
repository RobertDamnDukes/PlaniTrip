    ...
    <div className="fullWindow">
      ...
      <div className="planning-section">
        <div className="location-inputs">
          ...
          <button className="sign-up-button search-locations-go"></button>
        </div>
      </div>
